...
namespace One_To_Many.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StuId,StuName")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StuId,StuName")] Student student)
        {
            if (id != student.StuId)
            {
                return NotFound();
